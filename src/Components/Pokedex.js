  ...
  return (
    <div>
      ...
      <h2 className="welcome">
        {' '}
        <b style={{ color: 'rgba(221, 26, 26, 1)' }}>Hola, {user}</b> aquí
        podrás encontrar tu pokemon favorito{' '}
      </h2>
            ...
            {types.map(type => (
              <option key={type.url} value={type.url}>
                ...
                {type.name === 'normal'
                  ...
                  : 'WWW' && type.name === 'grass'
                  ? 'hierba'
                  : 'lll' && type.name === 'flying'
                  ? 'volador'
                  : 'lll' && type.name === 'poison'
                  ? 'veneno'
                  : 'lll' && type.name === 'electric'
                  ? 'eléctrico'
                  : 'lll' && type.name === 'bug'
                  ? 'bicho'
                  : 'lll' && type.name === 'dragon'
                  ? 'dragón'
                  : 'lll' && type.name === 'steel'
                  ? 'acero'
                  : 'lll' && type.name === 'psychic'
                  ? 'psíquico'
                  : 'lll' && type.name === 'fairy'
                  ? 'hada'
                  : 'lll' && type.name === 'fighting'
                  ? 'lucha'
                  : 'lll' && type.name === 'ice'
                  ? 'hielo'
                  : 'lll' && type.name === 'ground'
                  ? 'tierra'
                  : 'lll' && type.name === 'fire'
                  ? 'fuego'
                  : 'lll' && type.name === 'rock'
